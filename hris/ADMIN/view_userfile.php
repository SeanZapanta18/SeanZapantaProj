...
<head>
  ...
  <meta http-equiv="authors" content="GROUP 1 BSCS 4A">
  ...
  <header>
    ...
    <div class="list-group list-group-flush">
       ...
       <!-- <a href="#" id="add_user" class="list-group-item list-group-item-action waves-effect" data-toggle="modal" data-target="#modalRegisterForm2">
        ...
        <a href="view_userfile.php" id="view_file" class="list-group-item active list-group-item-action waves-effect">
      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <form class="d-flex justify-content-center">
            ...
            <!-- <input id="bar_search" type="search" placeholder="Search files or names here ..." aria-label="Search" class="form-control" name="search">
...
<hr>
 ...
 <tbody>
    <tr>
      <?php 
      require_once("include/connection.php");
      $query = mysqli_query($conn,"SELECT DISTINCT ID,NAME,SIZE,UPLOADER,ADMIN_STATUS,TIMERS,DOWNLOAD FROM upload_files WHERE ADMIN_STATUS = 'Employee' group by NAME DESC") or die (mysqli_error($con));
      ...
      <td><?php echo $dl; ?></td>
      <td>
        <a href='downloads.php?file_id=<?php echo $id; ?>' class='btn btn-sm btn-outline-primary' id="download_btn">
          <i class="fa fa-download"></i>
        </a>
        <!-- Delete button -->
        <a href='delete.php?ID=<?php echo $id; ?>' class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure you want to delete this record?')">
