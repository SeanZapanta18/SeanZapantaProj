...
<a style="letter-spacing: 3px; font-size: 50px;" class="navbar-brand" href="#"><img style="margin-right: 0px" id="logo" src="img/catholic.png" width="120px" height="90px"> <font size="8" color="#ffff99">H</font>uman <font size="8" color="#ffff99">R</font>esources <font size="8" color="#ffff99">I</font>nformation <font size="8" color="#ffff99">S</font>ystem</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
    ...
    <ul class="navbar-nav nav-flex-icons">
                  <li style="margin: 10px 15px">
                    <font size="4">Welcome,</font><font size="4" color="#0000ff"> <?php echo ucwords(htmlentities($id));?> </font>
                  </li>
            

            <li class="nav-item">
              <a style="padding: 8px; margin-right: 1rem;" href="logout.php" class="nav-link border border-light rounded waves-effect">
      ...
      <div class="row"><br>
        <form action="fileprocess.php" method="post" enctype="multipart/form-data" >
          <div class="col-md-11">
              ...
              ?>
                <input hidden name="uploader" value="<?php echo ucwords(htmlentities($fname)); ?>" class="form-control" >
